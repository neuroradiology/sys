...
(DEFUN COMTAB-CHAR-INDIRECTION (CHAR &OPTIONAL (COMTAB *COMTAB*))
  (DO ((CH CHAR (DPB (FIRST NCH) %%KBD-CONTROL-META (SECOND NCH)))
       (NCH))
    ...
    (PROGN (FUNCALL (WINDOW-SHEET *WINDOW*)	;Don't expose yet, but on first redisplay
	   ...
	   (*CATCH 'RETURN-FROM-COMMAND-LOOP
	     (*CATCH (IF TOP-LEVEL-P 'EXIT-TOP-LEVEL 'EXIT-CONTROL-R)
	       (DO () (NIL)
		 (*CATCH 'SYS:COMMAND-LEVEL    ;Catch C-Z in error handlers.
...
(DEFUN TYI-WITH-SCROLLING-AND-MOUSING ()
  (DO (CH REAL-CH) (NIL)
    ...
    (IF (LDB-TEST %%KBD-MOUSE CH)
	(APPLY #'PROCESS-SPECIAL-COMMAND REAL-CH)
	(RETURN CH))))

(DEFUN CHECK-FOR-TYPEOUT-WINDOW-TYPEOUT ()
  (COND ((TYPEOUT-WINDOW-INCOMPLETE-P *TYPEOUT-WINDOW*)
	 (FUNCALL *TYPEOUT-WINDOW* ':MAKE-COMPLETE)
	 (WITHOUT-IO-BUFFER-OUTPUT-FUNCTION
...
(DEFUN BARF (&OPTIONAL CTL-STRING &REST ARGS &AUX TEM1 TEM2)
  ...
  (MULTIPLE-VALUE (TEM1 TEM2)
    (LEXPR-FUNCALL #'SIGNAL 'BARF CTL-STRING ARGS))
  (IF TEM1 TEM2
...
;	    #/C COM-COMPILE-DEFUN
;	    #/E COM-EVALUATE-DEFUN
;	    #/E COM-EVALUATE-DEFUN-VERBOSE
;	    #/E COM-EVALUATE-DEFUN-HACK
;	    #/? COM-SELF-DOCUMENT
	    #/? COM-SELF-DOCUMENT
	    #/? COM-DOCUMENTATION
...
;	    #/ COM-DESCRIBE-VARIABLE-AT-POINT
;	    #/A COM-QUICK-ARGLIST
;	    #/D COM-BRIEF-DOCUMENTATION
;	    #/D COM-LONG-DOCUMENTATION
;	    #/V COM-DESCRIBE-VARIABLE-AT-POINT
	  ...
	  (MAKE-COMMAND-ALIST
	   '(;; COM*:
	     ...
	     COM-LIST-VARIABLES COM-VARIABLE-APROPOS COM-VARIABLE-DOCUMENT COM-SET-VARIABLE
	     COM-GRIND-DEFINITION COM-GRIND-S-EXPRESSION COM-EVALUATE-INTO-BUFFER COM-TRACE
	     COM-VIEW-LOGIN-DIRECTORY COM-VIEW-XGP-QUEUE COM-VIEW-DOVER-QUEUE
	     COM-VIEW-TTY-USERS COM-VIEW-MAIL
	     ...
	     COM-RENAME-FILE COM-DELETE-FILE COM-COPY-TEXT-FILE COM-COPY-BINARY-FILE
	     ;; MODES:
	     ...
	     COM-EDIT-TAB-STOPS COM-MIDAS-MODE
  ...
  (SETQ *STANDARD-CONTROL-X-COMTAB*
	(SET-COMTAB NIL '(#/G COM-PREFIX-BEEP
			  ...
			  #/G COM-OPEN-GET-Q-REGISTER
			  #/X COM-PUT-Q-REGISTER
...
(DEFUN COMTAB-MOUSE-PROMPT (COMTAB STRING &AUX (INHIBIT-SCHEDULING-FLAG T))
  ...
  (DO ((BUTTON 0 (1+ BUTTON))
    ...
    (DO ((CLICKS 0 (1+ CLICKS))
	 (COMMAND) (PROMPT))
	(( CLICKS 2))
      (COND ((OR (AND (SETQ COMMAND (COMMAND-LOOKUP (DPB 1 %%KBD-MOUSE
							 (DPB CLICKS %%KBD-MOUSE-N-CLICKS
							      (DPB BUTTON %%KBD-MOUSE-BUTTON
								   0)))
						    COMTAB))
	     ...
	     (AND (> CLICKS 0) (ARRAY-PUSH-EXTEND STRING #/2))
...
(DEFUN INITIALIZE-MINI-BUFFER ()
  ...
  (SETQ *PATHNAME-READING-COMTAB*
	(SET-COMTAB NIL '(#/ COM-PATHNAME-COMPLETE
;			  #/? COM-PATHNAME-LIST-COMPLETIONS
			  #/Q COM-QUOTED-INSERT
